...
try: 
	...
	while True: 
		...
		brightness3 = (math.sin((2 * math.pi * f * t) - 0.572))**2
		duty3 = brightness3 * 100
		pwm3.ChangeDutyCycle(duty3)

		brightness4 = (math.sin((2 * math.pi * f * t) - 0.857))**2
		duty4 = brightness4 * 100
		pwm4.ChangeDutyCycle(duty4)

		brightness5 = (math.sin((2 * math.pi * f * t) - 1.142))**2
		duty5 = brightness5 * 100
		pwm5.ChangeDutyCycle(duty5)

		brightness6 = (math.sin((2 * math.pi * f * t) - 1.428))**2
		duty6 = brightness6 * 100
		pwm6.ChangeDutyCycle(duty6)

		brightness7 = (math.sin((2 * math.pi * f * t) - 1.713))**2
		...
		brightness9 = (math.sin((2 * math.pi * f * t) - 2.285))**2
		duty9 = brightness9 * 100
		pwm9.ChangeDutyCycle(duty9)

		brightness10 = (math.sin((2 * math.pi * f * t) - 2.57))**2
